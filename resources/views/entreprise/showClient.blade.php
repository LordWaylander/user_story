<x-app-layout>
    ...
    <div class="m-4">
        ...
        @if (session()->has('message'))
          <div class="flex items-center bg-green-500 text-white text-sm font-bold px-4 py-3 rounded-md mx-12 my-4">
            {{ session('message') }}
          </div>
        @endif
        <div class="mx-12">
        <div class="w-full inputcreateclient h-10 d-flex align-items-center justify-between">
            ...
            <div class="mx-2">
                <a href="{{URL::to("entreprise/editClient/$entreprise->id_entreprise")}}"><img src="{{ URL::asset('images/edit_white.png') }}" alt="edit"></a>
            </div>
        </div>
