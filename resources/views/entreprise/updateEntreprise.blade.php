<x-app-layout>
    ...
    <div class="m-4">
        ...
        <form class="" action="{{ route('entreprise.update', $entreprise->id_entreprise) }}" method="post">
            @csrf
            ...
            <div class="flex items-center justify-around mt-4">
                <a class="px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 :opacity-25 transition no-underline" href="{{URL::to('entreprise/showEntreprise/$entreprise->id_entreprise')}}">{{ __('Retour à l\'entreprise') }}</a>
